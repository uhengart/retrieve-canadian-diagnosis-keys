...
_OUTBREAKEVENTEXPORT = _descriptor.Descriptor(
  name='OutbreakEventExport',
  full_name='OutbreakEventExport',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='start_timestamp', full_name='OutbreakEventExport.start_timestamp', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_timestamp', full_name='OutbreakEventExport.end_timestamp', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='locations', full_name='OutbreakEventExport.locations', index=2,
...
_OUTBREAKEVENTEXPORTSIGNATURE = _descriptor.Descriptor(
  name='OutbreakEventExportSignature',
  full_name='OutbreakEventExportSignature',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='signature', full_name='OutbreakEventExportSignature.signature', index=0,
...
_OUTBREAKEVENTEXPORT.fields_by_name['locations'].message_type = _OUTBREAKEVENT
...
DESCRIPTOR.message_types_by_name['OutbreakEventExport'] = _OUTBREAKEVENTEXPORT
DESCRIPTOR.message_types_by_name['OutbreakEventExportSignature'] = _OUTBREAKEVENTEXPORTSIGNATURE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

OutbreakEvent = _reflection.GeneratedProtocolMessageType('OutbreakEvent', (_message.Message,), {
  'DESCRIPTOR' : _OUTBREAKEVENT,
  '__module__' : 'outbreaks_pb2'
...
OutbreakEventExport = _reflection.GeneratedProtocolMessageType('OutbreakEventExport', (_message.Message,), {
  'DESCRIPTOR' : _OUTBREAKEVENTEXPORT,
  '__module__' : 'outbreaks_pb2'
  # @@protoc_insertion_point(class_scope:OutbreakEventExport)
  })
_sym_db.RegisterMessage(OutbreakEventExport)

OutbreakEventExportSignature = _reflection.GeneratedProtocolMessageType('OutbreakEventExportSignature', (_message.Message,), {
  'DESCRIPTOR' : _OUTBREAKEVENTEXPORTSIGNATURE,
  '__module__' : 'outbreaks_pb2'
  # @@protoc_insertion_point(class_scope:OutbreakEventExportSignature)
  })
_sym_db.RegisterMessage(OutbreakEventExportSignature)
